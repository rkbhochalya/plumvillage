    ...
    <div class="align<?php echo $block['align']; if(isset($block['className'])){ echo ' ' . $block['className']; } ?>">
        <div class="row row-collapsable">
            <?php while ( have_rows('monastics') ) : the_row(); ?>
                ...
                <div class="index-item index-monastic col-6 <?php if(count(get_field('monastics')) == 2) : ?>col-md-6<?php elseif(count(get_field('monastics')) >= 3) : ?>col-md-4<?php else : ?>col-md-12<?php endif; ?> ">
