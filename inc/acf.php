...
function register_acf_block_types() {
    ...
    acf_register_block_type(array(
        ...
        'render_template'   => 'template-parts/blocks/books-panel.php',
        'category'          => 'plumvillage',
        'icon'              => 'book',
    ...
    acf_register_block_type(array(
        ...
        'render_template'   => 'template-parts/blocks/videos-panel.php',
        'category'          => 'plumvillage',
        'icon'              => 'video-alt3',
    ...
    acf_register_block_type(array(
        ...
        'render_template'   => 'template-parts/blocks/links-panel.php',
        'category'          => 'plumvillage',
        'icon'              => 'editor-ul',
    ...
    acf_register_block_type(array(
        ...
        'render_template'   => 'template-parts/blocks/pages-panel.php',
        'category'          => 'plumvillage',
        'icon'              => 'admin-page',
    ...
    acf_register_block_type(array(
        ...
        'render_template'   => 'template-parts/blocks/quotes-panel.php',
